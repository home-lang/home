...
pub const cli = struct {
    ...
    pub const PatchCommitCommand = @import("runtime/cli/patch_commit_command.zig").PatchCommitCommand;
...
pub const runtime = struct {
    ...
    pub const shell = struct {
        ...
        pub const TestingAPIs = @import("runtime/shell/shell.zig").TestingAPIs;
        pub const LEX_JS_OBJREF_PREFIX = @import("runtime/shell/shell.zig").LEX_JS_OBJREF_PREFIX;
        pub const LEX_JS_STRING_PREFIX = @import("runtime/shell/shell.zig").LEX_JS_STRING_PREFIX;
