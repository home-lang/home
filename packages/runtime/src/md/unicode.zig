// Copied verbatim from bun/src/md/unicode.zig at upstream
// SHA fd0b6f1a271fca0b8124b69f230b100f4d636af6. MIT — see ../cli/LICENSE.bun.md.
//
// Unicode case-folding table for the markdown parser (`caseFold(u21) FoldInfo`)
// plus the upstream-provided "Kelvin sign" inline test. No `@import("bun")`
// references — pure std-only data tables.
