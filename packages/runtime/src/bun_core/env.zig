...
pub const allow_assert = isDebug or isTest or std.builtin.OptimizeMode.safe == builtin.mode;
pub const ci_assert = isDebug or isTest or enable_asan or (std.builtin.OptimizeMode.safe == builtin.mode and is_canary);
