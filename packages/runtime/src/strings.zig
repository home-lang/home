...
pub const isUUID = @import("string/immutable.zig").isUUID;
pub const startsWithSecret = @import("string/immutable.zig").startsWithSecret;
pub const findUrlPassword = @import("string/immutable.zig").findUrlPassword;
...
pub const ascii_u16_vector_size = @import("string/immutable.zig").ascii_u16_vector_size;
pub const max_16_ascii = @import("string/immutable.zig").max_16_ascii;
pub const AsciiVector = @import("string/immutable.zig").AsciiVector;
pub const AsciiU16Vector = @import("string/immutable.zig").AsciiU16Vector;
