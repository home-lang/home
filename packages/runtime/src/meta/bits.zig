// Copied from bun/src/meta/bits.zig at upstream SHA
// fd0b6f1a271fca0b8124b69f230b100f4d636af6. MIT — see ../cli/LICENSE.bun.md.
//
// Pure-Zig leaf file; no @import("bun") rewrite needed.
...
test "bitfield helpers on packed bool struct" {
    ...
    const a: Flags = .{ .read = true, .write = true };
    const b: Flags = .{ .write = true };
    const c: Flags = .{ .execute = true };
