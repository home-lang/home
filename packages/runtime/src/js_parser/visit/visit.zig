pub fn Visit(
    ...
    return struct {
        ...
        pub const visitExpr = @import("./visit_expr.zig").VisitExpr(parser_feature__typescript, parser_feature__jsx, parser_feature__scan_only).visitExpr;
        pub const visitExprInOut = @import("./visit_expr.zig").VisitExpr(parser_feature__typescript, parser_feature__jsx, parser_feature__scan_only).visitExprInOut;
        pub const visitAndAppendStmt = @import("./visit_stmt.zig").VisitStmt(parser_feature__typescript, parser_feature__jsx, parser_feature__scan_only).visitAndAppendStmt;
