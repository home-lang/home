...
pub fn NewRequestContext(comptime ssl_enabled: bool, comptime debug_mode: bool, comptime ThisServer: type, comptime http3: bool) type {
    return struct {
        ...
        pub fn renderDefaultError(
            ...
            this.response_buf_owned = std.ArrayListUnmanaged(u8){ .items = bb.items, .capacity = bb.capacity, .pointer_stability = .{} };
        ...
        comptime {
            ...
            if (bun.Environment.export_cpp_apis or bun.Environment.isNative) {
