inline fn toHaveReturnedTimesFn(this: *Expect, globalThis: *JSGlobalObject, callframe: *CallFrame, comptime mode: enum { toHaveReturned, toHaveReturnedTimes }) home_rt.JSError!JSValue {
    jsc.markBinding(@src());
...
pub fn toHaveReturned(this: *Expect, globalThis: *JSGlobalObject, callframe: *CallFrame) home_rt.JSError!JSValue {
    return toHaveReturnedTimesFn(this, globalThis, callframe, .toHaveReturned);
}

pub fn toHaveReturnedTimes(this: *Expect, globalThis: *JSGlobalObject, callframe: *CallFrame) home_rt.JSError!JSValue {
