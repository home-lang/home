// Copied from bun/src/runtime/api/JSONCObject.zig at upstream SHA fd0b6f1a27. MIT.
// Re-attached 2026-06-23: deps (interchange.json.parseTSConfig, Expr.toJS) landed.
// Was a .zero stub that segfaulted JSC on Bun.JSONC access.
