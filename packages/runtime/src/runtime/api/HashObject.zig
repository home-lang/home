...
// Re-attached (2026-06-23): the full JS bridge + create() registry now that
// home_rt exposes JSFunction.create / ArgumentsSlice / WebCore.Blob / zlib.crc32
// / deprecated.RapidHash. Previously parked as a stub returning JSValue.zero,
// which segfaulted JSC when `Bun.hash` was accessed (a .zero lazy-prop value).
