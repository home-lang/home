...
// Original: src/runtime/bake/DevServer/HmrSocket.zig at 4982b91e3702094330f3be3883354c52b8c01323.
        ...
        .testing_batch_events => switch (s.dev.testing_batch_events) {
            ...
            .enabled => |event_const| {
                ...
                s.dev.startAsyncBundle(
                    event.entry_points,
                    true,
                    bun.Timer.start() catch @panic("timers unsupported"),
