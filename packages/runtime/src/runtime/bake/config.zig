...
// Original: src/runtime/bake/bake.zig at 4982b91e3702094330f3be3883354c52b8c01323.
    ...
    pub fn react(arena: std.mem.Allocator) !Framework {
        return .{
            ...
            .built_in_modules = bun.StringArrayHashMapUnmanaged(BuiltInModule).init(arena, &.{
                ...
                .{ .code = bun.runtimeEmbedFile(.src, "runtime/bake/bun-framework-react/client.tsx") },
                .{ .code = bun.runtimeEmbedFile(.src, "runtime/bake/bun-framework-react/server.tsx") },
                .{ .code = bun.runtimeEmbedFile(.src, "runtime/bake/bun-framework-react/ssr.tsx") },
