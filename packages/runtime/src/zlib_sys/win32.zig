// Copied verbatim from bun/src/zlib_sys/win32.zig at upstream SHA
// fd0b6f1a271fca0b8124b69f230b100f4d636af6. MIT — see ../cli/LICENSE.bun.md.
// No `@import("bun")` references; `./shared.zig` already lives in our tree.
...
test "zlib_sys.win32 z_stream size matches the LLP64 layout" {
    // On Windows LLP64, `uLong` is c_ulong (4 bytes). z_stream layout
    // therefore differs from the cloudflare/zlib uint64_t variant; this
    // smoke test just ensures the struct is non-zero-sized and that the
    // shared enum re-exports resolve.
