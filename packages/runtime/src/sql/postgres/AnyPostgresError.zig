// Copied from bun/src/sql/postgres/AnyPostgresError.zig at upstream
// SHA fd0b6f1a271fca0b8124b69f230b100f4d636af6. MIT — see ../../cli/LICENSE.bun.md.
// The two `createPostgresError` / `postgresErrorToJS` re-exports at the
// bottom of the upstream file reach into `sql_jsc/postgres/error_jsc.zig`
// (JSC bridge). They re-land under `src/sql_jsc/` in Phase 12.2.
