// Copied verbatim from bun/src/sql/mysql/protocol/CharacterSet.zig at upstream
...
test "CharacterSet.default points at utf8mb4_general_ci" {
    const std = @import("std");
    try std.testing.expectEqual(CharacterSet.utf8mb4_general_ci, CharacterSet.default);
    try std.testing.expectEqual(@as(u8, 45), @intFromEnum(CharacterSet.default));
}

test "CharacterSet.label resolves canonical sub-100 charsets" {
    const std = @import("std");
    try std.testing.expectEqualStrings("big5_chinese_ci", CharacterSet.big5_chinese_ci.label());
    try std.testing.expectEqualStrings("utf8mb4_general_ci", CharacterSet.utf8mb4_general_ci.label());
    // 100+ falls into the unknown bucket.
    try std.testing.expectEqualStrings("(unknown)", CharacterSet.utf16_unicode_ci.label());
}
