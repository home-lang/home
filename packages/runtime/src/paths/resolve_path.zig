...
//
// Home port note: this is a focused pure-path subset for Zig 0.17-dev. It
// keeps Bun's public helper names for normalization, joining, absoluteness,
// dirname/relative, and PATH-style env tests, while parking syscall/JSC/NT
// platform pieces that need the rest of Bun's runtime.
...
pub fn lastIndexOfSeparatorPosix(str: []const u8) ?usize {
    return std.mem.lastIndexOfScalar(u8, str, '/');
}
