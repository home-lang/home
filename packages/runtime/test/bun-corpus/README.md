...
- `home test packages/runtime/test/bun-corpus/` is the full acceptance gate and
  ...
  Latest measured subset run: `253` files, `1,118` passed, `0` failed,
  ...
  imports for the empty async-transpiler regression fixture, third-party
  ...
  header/encoding plus missing-secret validation coverage, and current compile-mode
