...
/// Test-and-test-and-set spinlock built from a u32 atomic. `std.atomic.Mutex`
/// was removed in Zig 0.16; see also packages/codegen/src/type_registry.zig
...
pub const PackageManager = struct {
    ...
    fn downloadAll(self: *PackageManager) !void {
        if (self.lockfile) |lock| {
            ...
            var errors = std.ArrayList(DownloadError).empty;
...
pub const LockFile = struct {
    ...
    pub fn create(allocator: std.mem.Allocator, packages: []ResolvedPackage) !*LockFile {
        ...
        lock.* = .{
            .allocator = allocator,
            .version = 1,
            .packages = std.ArrayList(LockedPackage).empty,
        };
    ...
    pub fn save(self: *LockFile, path: []const u8, io: ?Io) !void {
        ...
        try content.appendSlice(self.allocator, "# This file is generated by home pkg\n");
...
pub const DependencyResolver = struct {
    ...
    pub fn resolve(self: *DependencyResolver) ![]ResolvedPackage {
        ...
        // Convert to slice
        var result = std.ArrayList(ResolvedPackage).empty;
