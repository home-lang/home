...
///
/// This module generates LLVM IR from Ion AST, enabling:
...
pub const LLVMCodegen = struct {
    ...
    fn emitHeader(self: *LLVMCodegen) !void {
        ...
        try writer.writeAll("; Generated by Ion Compiler - LLVM IR Backend\n");
        try writer.writeAll("; Target: x86_64-unknown-linux-gnu\n");
