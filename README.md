...
| **Bun runtime — files integrated** | **549 / 1,193 — ~46.0%** | Home-import-rewritten, Zig 0.17-clean, build-wired, and tested |
...
| **Total test count** | **6,345 / 6,468 — ~98%** (123 skipped, 0 failed) | `zig build test --summary all` on Zig 0.17.0-dev — full unit + integration + conformance pin suite |
...
| **Bun source files integrated** | **549 / 1,193** | **~46.0%** |
