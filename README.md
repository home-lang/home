...
| **Total test count** | **6,684 / 6,685 — ~100%** (1 skipped, 0 failed) | `./pantry/.bin/zig build test --summary all` on Zig 0.17.0-dev — full unit + integration + conformance pin suite |
