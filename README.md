...
> TS diagnostic-code coverage (742 / 2,076 emitted) tracks the catalog-
...
| **TypeScript — diagnostic codes emitted** | **742 / 2,076 — ~35.7%** | `docs/TS_DIAGNOSTIC_CODE_STATUS.md` — codes referenced from production source; 1,331 catalog-only remain |
...
| TS diagnostic-code catalogue | **742 / 2,076 emitted — ~35.7%** | Mirrors the full upstream code → message table; powers `home-lsp` hover-on-`TS1234`. 1,331 catalog-only entries remain (see `docs/TS_DIAGNOSTIC_CODE_STATUS.md`). |
