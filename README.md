...
> TS diagnostic-code coverage (647 / 2,076 emitted) tracks the catalog-
...
| **TypeScript — diagnostic codes emitted** | **647 / 2,076 — ~31.2%** | `docs/TS_DIAGNOSTIC_CODE_STATUS.md` — codes referenced from production source; 1,427 catalog-only remain |
...
| TS diagnostic-code catalogue | **647 / 2,076 emitted — ~31.2%** | Mirrors the full upstream code → message table; powers `home-lsp` hover-on-`TS1234`. 1,427 catalog-only entries remain (see `docs/TS_DIAGNOSTIC_CODE_STATUS.md`). |
