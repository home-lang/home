...
> TS diagnostic-code coverage (883 / 2,076 emitted) tracks the catalog-
...
| TS diagnostic-code catalogue | **883 / 2,076 emitted — ~42.5%** | Mirrors the full upstream code → message table; powers `home-lsp` hover-on-`TS1234`. 1,189 catalog-only entries remain (see `docs/TS_DIAGNOSTIC_CODE_STATUS.md`). |
