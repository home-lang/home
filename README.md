...
> TS diagnostic-code coverage (651 / 2,076 emitted) tracks the catalog-
...
| **TypeScript — diagnostic codes emitted** | **651 / 2,076 — ~31.4%** | `docs/TS_DIAGNOSTIC_CODE_STATUS.md` — codes referenced from production source; 1,423 catalog-only remain |
...
| TS diagnostic-code catalogue | **651 / 2,076 emitted — ~31.4%** | Mirrors the full upstream code → message table; powers `home-lsp` hover-on-`TS1234`. 1,423 catalog-only entries remain (see `docs/TS_DIAGNOSTIC_CODE_STATUS.md`). |
