...
> TS diagnostic-code coverage (894 / 2,076 emitted) tracks the catalog-
...
| **TypeScript — diagnostic codes emitted** | **894 / 2,076 — ~43.1%** | `docs/TS_DIAGNOSTIC_CODE_STATUS.md` — codes referenced from production source; 1,178 catalog-only remain |
...
| TS diagnostic-code catalogue | **894 / 2,076 emitted — ~43.1%** | Mirrors the full upstream code → message table; powers `home-lsp` hover-on-`TS1234`. 1,178 catalog-only entries remain (see `docs/TS_DIAGNOSTIC_CODE_STATUS.md`). |
