...
> TS diagnostic-code coverage (887 / 2,076 emitted) tracks the catalog-
...
| **TypeScript — diagnostic codes emitted** | **887 / 2,076 — ~42.7%** | `docs/TS_DIAGNOSTIC_CODE_STATUS.md` — codes referenced from production source; 1,185 catalog-only remain |
...
| TS diagnostic-code catalogue | **887 / 2,076 emitted — ~42.7%** | Mirrors the full upstream code → message table; powers `home-lsp` hover-on-`TS1234`. 1,185 catalog-only entries remain (see `docs/TS_DIAGNOSTIC_CODE_STATUS.md`). |
