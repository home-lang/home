...
> TS diagnostic-code coverage (642 / 2,076 emitted) tracks the catalog-
...
| **TypeScript — diagnostic codes emitted** | **642 / 2,076 — ~30.9%** | `docs/TS_DIAGNOSTIC_CODE_STATUS.md` — codes referenced from production source; 1,432 catalog-only remain |
...
| TS diagnostic-code catalogue | **642 / 2,076 emitted — ~30.9%** | Mirrors the full upstream code → message table; powers `home-lsp` hover-on-`TS1234`. 1,432 catalog-only entries remain (see `docs/TS_DIAGNOSTIC_CODE_STATUS.md`). |
