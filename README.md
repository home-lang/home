...
| **Bun runtime — files integrated** | **547 / 1,193 — ~45.9%** | Home-import-rewritten, Zig 0.17-clean, build-wired, and tested |
...
| **Total test count** | **6,334 / 6,458 — ~98%** (124 skipped, 0 failed) | `zig build test --summary all` on Zig 0.17.0-dev — full unit + integration + conformance pin suite |
...
| **Bun source files integrated** | **547 / 1,193** | **~45.9%** |
