...
> TS diagnostic-code coverage (905 / 2,076 emitted) tracks the catalog-
...
| **TypeScript — diagnostic codes emitted** | **905 / 2,076 — ~43.6%** | `docs/TS_DIAGNOSTIC_CODE_STATUS.md` — codes referenced from production source; 1,167 catalog-only remain |
...
| TS diagnostic-code catalogue | **905 / 2,076 emitted — ~43.6%** | Mirrors the full upstream code → message table; powers `home-lsp` hover-on-`TS1234`. 1,167 catalog-only entries remain (see `docs/TS_DIAGNOSTIC_CODE_STATUS.md`). |
