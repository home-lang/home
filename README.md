...
| [Global-namespace negative index](docs/docs/TS_PERFORMANCE.md#global-namespace-negative-index-rejected) | 128 interface families: 0.996× wall, 4/10 wins | Wall and CPU paired CIs cross zero; no scale run admitted | Rejected and reverted |
| [Qualified-annotation root namespace index](docs/docs/TS_PERFORMANCE.md#qualified-annotation-root-namespace-index-rejected) | 128 interface families: 1.082× lower wall mean, 6/10 wins | Wall and CPU paired CIs cross zero; no scale run admitted | Rejected and reverted |
...
| [Prototype-assignment marker gate](docs/docs/TS_PERFORMANCE.md#prototype-assignment-marker-gate-rejected) | 128 interface families: 0.996× wall, 5/10 wins | Wall and CPU paired CIs cross zero; no scale timing admitted | Rejected and reverted |
| [Import-free module-namespace gate](docs/docs/TS_PERFORMANCE.md#import-free-module-namespace-gate-rejected) | 128 interface families: 0.998× wall, 5/10 wins | Wall and CPU paired CIs cross zero; no confirmation or scale timing admitted | Rejected and reverted |
| [Type-alias heritage fallback gate](docs/docs/TS_PERFORMANCE.md#type-alias-heritage-fallback-gate-rejected) | 128 interface families: 1.019× lower wall mean, 6/10 wins | Loaded screen and replacement CIs cross zero; no scale timing admitted | Rejected and reverted |
...
| [Identifier declaration-slot reuse](docs/docs/TS_PERFORMANCE.md#rejected-identifier-declaration-slot-reuse) | 2,048 families: 0.995× CPU, 5/10 wins | 32,768-family 2026-09-12 retest: 1.103× lower mean, 15/20 wins, but paired 95% CI crosses zero | Rejected and reverted |
