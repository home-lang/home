...
> TS diagnostic-code coverage (649 / 2,076 emitted) tracks the catalog-
...
| **TypeScript — diagnostic codes emitted** | **649 / 2,076 — ~31.3%** | `docs/TS_DIAGNOSTIC_CODE_STATUS.md` — codes referenced from production source; 1,425 catalog-only remain |
...
| TS diagnostic-code catalogue | **649 / 2,076 emitted — ~31.3%** | Mirrors the full upstream code → message table; powers `home-lsp` hover-on-`TS1234`. 1,425 catalog-only entries remain (see `docs/TS_DIAGNOSTIC_CODE_STATUS.md`). |
