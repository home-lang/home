...
> TS diagnostic-code coverage (891 / 2,076 emitted) tracks the catalog-
...
| **TypeScript — diagnostic codes emitted** | **891 / 2,076 — ~42.9%** | `docs/TS_DIAGNOSTIC_CODE_STATUS.md` — codes referenced from production source; 1,181 catalog-only remain |
...
| TS diagnostic-code catalogue | **891 / 2,076 emitted — ~42.9%** | Mirrors the full upstream code → message table; powers `home-lsp` hover-on-`TS1234`. 1,181 catalog-only entries remain (see `docs/TS_DIAGNOSTIC_CODE_STATUS.md`). |
