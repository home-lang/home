  ...
  code:
    ...
    - file: terminal
      ...
      content: |
        ...
        # The same toolchain checks your TypeScript
        home-tsc --noEmit
...
<section class="hl-metrics">
  ...
  <p class="hl-metrics-note">Every figure is a file-count or row-count measurement against an external baseline, refreshed 2026-08-28. <a href="/docs/PARITY-STATUS">Read how each one is produced</a>.</p>
</section>
  ...
  <div class="hl-band-grid">
    <div>
      ...
      <ul class="hl-band-points">
        ...
        <li><strong>Editors keep working.</strong> <code>home-lsp</code> speaks the protocol your editor already speaks.</li>
      </ul>
    </div>
    <div class="hl-code">
...
```bash
# Point the Home toolchain at the project you already have
...
# Incremental rebuilds while you edit
home-tsc --watch
```
