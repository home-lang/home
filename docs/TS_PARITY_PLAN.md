...
**Current phase:** Phases 3/5/6/8 all moving — member-access type checking, LSP foundation (hover/def/refs/completions/diagnostics), control-flow narrowing via typeof guards, persistent compilation cache
**Active deliverable:** Phase 3 — generic instantiation; Phase 5 §11.6 — disk-backed cache persistence, query DB integration
...
| **New: `packages/ts_lsp`** | LSP query surface (hover/def/refs/completions/diagnostics) | Phase 8 — *foundation landed 2026-05-05* |
