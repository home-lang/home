...
13. ~~**`.d.hm` emitter**~~ (the Home-side analogue). 🟢 partial 2026-05-06. Symmetric to `.d.ts` symbol-driven track over Home's HIR. **Basic framing emitter landed** (commit `9e56d2e`) — top-level decl scaffolding only; member rendering + type re-printing is the follow-up.
