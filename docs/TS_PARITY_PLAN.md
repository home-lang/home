...
**Current phase:** Phase 1.D follow-ups continuing in parallel with Phases 2/3/4 deepening — real type-annotation parsing landed; VarDecl HIR nodes replace assignment lowering
**Active deliverable:** arrow functions + generics-on-decls + driver wiring
