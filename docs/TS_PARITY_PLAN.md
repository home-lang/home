...
**Current phase:** Phase 1.D essentially complete; driver, JSX, source maps, and module resolution landed; Phases 2/3/4 deepened
**Active deliverable:** Phase 5 — performance engineering, parallelization, query DB wiring; Phase 6 — conformance hardening
...
| **New: `packages/ts_emit`** | JS + .d.ts emit + source maps V3 | Phase 4 — *JS emit + source-map V3 generator landed 2026-05-05* |
| **New: `packages/ts_driver`** | Lex → parse → bind → emit pipeline | Phase 4.5 — *single-file E2E landed 2026-05-05* |
