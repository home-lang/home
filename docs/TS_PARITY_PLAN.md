...
**Current phase:** Phase 4 — JS emit + .d.hm scaffolds landed; foundation in place across Phases 1-4
**Active deliverable:** ready to start Phase 5 — performance engineering (parallel parse/bind/check, two-level relation cache, query DB wiring)
...
| **New: `packages/ts_emit`** | JS + .d.ts emit (symbol-driven track) | Phase 4 — *JS emit landed 2026-05-05* |
