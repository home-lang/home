...
[pattern matching](/docs/features/pattern-matching) turns that into a compile
error:
...
[FFI](/docs/features/ffi), with struct layout and callback signatures expressed in
...
[capability matrix](/docs/CAPABILITY_MATRIX) before planning around a specific
feature.
