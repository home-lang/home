...
This command supplies native root/test installation and its durable outcomes. Services, complete vendor preparation and integration into the default full CI coordinator remain tracked in #724; original clean test installation remains unresolved in #725.
