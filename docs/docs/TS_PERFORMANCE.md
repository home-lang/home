...
Measured 2026-08-26 at commit `822bb0259` on an Apple M3 Pro MacBook Pro
(11 cores, 18 GB RAM, arm64, macOS 27.0). Each value is the mean and sample
standard deviation of 30 new compiler processes after five warmup rounds.

| Workload | tsc 7.0.2 | tsgo 7.0.0-dev.20260707.2 | Home 0.1.0 | Home vs fastest competitor |
|---|---:|---:|---:|---:|
| `startup` | 47.9 ± 18.8 ms | 44.9 ± 4.6 ms | **4.1 ± 0.4 ms** | **11.02× faster** |
| `many_files` | 62.0 ± 2.3 ms | 62.1 ± 1.9 ms | **38.2 ± 1.6 ms** | **1.62× faster** |
| `deep_types` | 67.5 ± 6.6 ms | 69.7 ± 9.8 ms | **55.8 ± 6.9 ms** | **1.21× faster** |
...
./bench/vs_tsgo/run.sh cold --runs 30 --warmup 5
...
- source loading reuses one I/O runtime per compilation; and
