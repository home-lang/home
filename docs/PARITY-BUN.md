...
--bun-corpus-native-subset=minimal-js` executes thirty-two allowlisted JS
...
`Map`/`Set` deep-equality, lifecycle hook, own-key matcher, and stack-trace smokes. The bootstrap harness is
