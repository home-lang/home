...
--bun-corpus-native-subset=minimal-js` executes thirty-eight allowlisted JS
...
`Bun.wrapAnsi` smokes, retry/repeats runner behavior, `test.concurrent.each`, and narrow bootstrap coverage for Node `DOMException`, Web
