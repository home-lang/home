...
--bun-corpus-native-subset=minimal-js` executes four allowlisted JS
...
smoke, the Web `atob`/`btoa` smoke, and two pure-JS regression smokes.
This is deliberately not the acceptance gate.
