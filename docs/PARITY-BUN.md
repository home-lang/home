...
--bun-corpus-native-subset=minimal-js` executes two hundred forty-eight allowlisted JS
...
third-party `jsonwebtoken` default-import decode/sign/verify coverage,
