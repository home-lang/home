...
--bun-corpus-native-subset=minimal-js` executes fifteen allowlisted JS
...
expectation smokes, and the Node `DOMException`, JSC `ShadowRealm`,
Bun file-metadata, and stack-trace smokes. This is deliberately not the
acceptance gate.
