...
--bun-corpus-native-subset=minimal-js` executes thirty-seven allowlisted JS
...
`Bun.wrapAnsi` smokes, retry/repeats runner behavior, and narrow bootstrap coverage for Node `DOMException`, Web
