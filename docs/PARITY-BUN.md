...
--bun-corpus-native-subset=minimal-js` executes three hundred three allowlisted JS
...
barrel, browser-target builtin diagnostics, CLI run/spawn stdin, CJS,
...
Latest measured subset run: `303` files, `1,255` passed, `0` failed,
`47` todo.
