...
--bun-corpus-native-subset=minimal-js` executes one hundred two allowlisted JS
...
zero-length string behavior plus basename/extname/normalize/join path table
coverage,
