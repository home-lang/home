...
--bun-corpus-native-subset=minimal-js` executes ninety-seven allowlisted JS
...
zero-length string behavior plus basename/extname path table coverage,
...
checks, and `expect.extend` matcher validation plus installed
