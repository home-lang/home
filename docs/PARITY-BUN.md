...
--bun-corpus-native-subset=minimal-js` executes thirty-nine allowlisted JS
...
`Bun.wrapAnsi` smokes, retry/repeats runner behavior, `test.concurrent.each`, Deno `CustomEvent`, and narrow bootstrap coverage for Node `DOMException`, Web
