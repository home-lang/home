...
--bun-corpus-native-subset=minimal-js` executes eighteen allowlisted JS
...
smoke, and the Node `DOMException`, JSC `ShadowRealm`, Bun
file-metadata, and stack-trace smokes. This is deliberately not the
acceptance gate.
