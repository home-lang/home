...
--bun-corpus-native-subset=minimal-js` executes one hundred three allowlisted JS
...
zero-length string behavior plus basename/extname/normalize/join/dirname path table
coverage,
