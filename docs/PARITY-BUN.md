...
--bun-corpus-native-subset=minimal-js` executes two hundred seventy-two allowlisted JS
...
proxy-safe data-property inspection,
...
Latest measured subset run: `272` files, `1,198` passed, `0` failed,
`46` todo.
