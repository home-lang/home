...
Pinned port baseline: `packages/runtime/UPSTREAM_SHA.txt` = `fd0b6f1a271fca0b8124b69f230b100f4d636af6` (Bun).
Upstream HEAD at capture: `7dd427e7ad` (`origin/main`).
Range: `fd0b6f1a27..origin/main` = **425 commits**.

Generated from `git log --oneline fd0b6f1a271fca0b8124b69f230b100f4d636af6..origin/main`. Triage each into: compiler/runtime-observable port vs codegen-noise vs infra/CI.
